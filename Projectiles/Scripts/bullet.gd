...
static var default_sprite = preload("res://Projectiles/Sprites/bullet.png")
static var boosted_sprite = preload("res://Projectiles/Sprites/boosted_bullet.png")
var direction = Vector2.RIGHT

static func spawn_bullet(dmg: float, speed: float, boosted: bool) -> Bullet:
	var my_scene: PackedScene = load("res://Projectiles/bullet.tscn")
